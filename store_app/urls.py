...
from store_app.views.product_details import VariantViewSet, VariantImageViewSet, ExtraDetailsViewSet
...
router.register(r'product_extra_details', ExtraDetailsViewSet, basename='product_extra_details')
